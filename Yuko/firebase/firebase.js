...
import { getFirestore, doc, updateDoc, setDoc, getDoc, collection, addDoc, arrayUnion  } from 'firebase/firestore';
...
export default app;
export { auth, db, arrayUnion, getAuth, collection, addDoc, signInWithEmailAndPassword, createUserWithEmailAndPassword, sendPasswordResetEmail, getFirestore, doc, updateDoc, setDoc, getDoc }
